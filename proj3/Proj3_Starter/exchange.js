...
const exchange_name = 'Chaos EX'; // TODO: fill in the name of your exchange

const token_name = 'CHAOS';             // TODO: replace with name of your token
const token_symbol = 'CHS';               // TODO: replace with symbol for your token
...
const token_address = '0x3fCD27F090Ca56228EEB32cfa4436c6291Ee8605';
const token_abi = [
    {
        "inputs": [],
...
const exchange_address = '0xEB289EB468AAce64275F1C1445034E55cbAb00A5';
const exchange_abi = [
    {
        "inputs": [],
        "name": "addLiquidity",
    ...
    },
    {
        ...
        "name": "liquidity_providers_percentage",
        "outputs": [
            {
                "internalType": "uint256",
                "name": "",
...
async function addLiquidity(amountEth, maxSlippagePct) {
    ...
    const pool_state = await getPoolState();
    const amountToken = amountEth * pool_state.token_eth_rate;
    ...
    await exchange_contract.methods.addLiquidity().send({ from: web3.eth.defaultAccount, value: amountEth, gas: 999999 });
...
async function removeLiquidity(amountEth, maxSlippagePct) {
    /** TODO: ADD YOUR CODE HERE **/
    await exchange_contract.methods.removeLiquidity(amountEth).send({ from: web3.eth.defaultAccount, gas: 999999 });
...
async function swapTokensForETH(amountToken, maxSlippagePct) {
    /** TODO: ADD YOUR CODE HERE **/
    await exchange_contract.methods.swapTokensForETH(amountToken).send({ from: web3.eth.defaultAccount, gas: 999999 });

}

async function swapETHForTokens(amountETH, maxSlippagePct) {
    /** TODO: ADD YOUR CODE HERE **/
    await exchange_contract.methods.swapETHForTokens().send({ from: web3.eth.defaultAccount, value: amountETH, gas: 999999 });
