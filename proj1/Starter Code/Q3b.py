...
def multisig_scriptSig(txin, txout, txin_scriptPubKey):
    ...
    return [
        bank_sig ,my_public_key, 0 , cust1_sig
    ]
    ######################################################################
...
if __name__ == '__main__':
    ...
    amount_to_send = 0.0001025 - 0.00001 # amount of BTC in the output you're sending minus fee
    txid_to_spend = (
        '39d124864021f05d089605bec4f72041985d4c61f97f2347d6e409d918d03678')
